...
EdgesMenu.addCommand('GuidedBlur', "nuke.createNode('{}GuidedBlur')".format(prefixNST), icon="nukepedia_icon.png")
...
utilitiesMenu.addCommand('ExpressionWaveGenerator', "nuke.createNode('{}ExpressionWaveGenerator')".format(prefixNST))
